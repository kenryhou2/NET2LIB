...
START pyinstaller --onefile -w --add-data src/dragndroplogo.png;src --add-data templates/ModelHeader_Public_Release.txt;templates --add-data src/ti_logo.png;src NET2LIBconverter_windows.py